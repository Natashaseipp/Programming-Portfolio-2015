...
def slice_of_perfection(str, num1, num2):
	return  str[num1: num1 + num2]
...
def main_strings():
	...
	print "testing second_letter('winner'): ", second_letter('winner') # i
	print "testing one_letter('no games', 6): ", one_letter("no games", 6) # e
	print "testing concatenate('orange', 'blue'): ", concatenate('orange', 'blue')
	print "testing concatenate('red', 'green'): ", concatenate('red', 'green')
	print "testing beauty('thats a'): ", beauty('thats a')
	print "testing beauty('the world is a'): ", beauty('the world is a')
	print "testing slice_of_life('elephant'): ", slice_of_life('elephant')
	print "testing slice_of_life('idkanymore'): ", slice_of_life('idkanymore')
	print "testing slice_of_heaven('abcdefgh): ", slice_of_heaven('abcefgh')
	print "testing slice_of_perfection('I want to go home so badly', 3, 8): ", slice_of_perfection('I want to go home so badly', 3, 8)
	print "tseting slice_of_perfection('please let me go home, im tired', 3, 7): ", slice_of_perfection('please let me go home, im tired', 3, 7)
	print "testing length(Natasha): ", length(Natasha)
	print "testing length(Christmas): ", length(Christmas)
...
def main_list():
	...
	print "test hallow(): ", hallow()
	b = [5, 27, 78, 42, 63, 84]
	a = [17, 38, 3, 23, 90, 80]
	print "testing third_value(b): ", third_value(b)
	...
	c = ["im", "over", "this", "i", "want", "to", "go", "home"]
	print "test sub_list2(c, 1): ", sub_list2(c, 1)
	print "test sub_list3(c, 3, 3): ", sublist3(c, 3, 3)
	print "test list_length(c): ", list_length(c)
	
def list_total(g):
	total = 0
	for every number in g:
		total += number 
	return total
...
def main_sequence_loop():
	lucky = [3, 7, 25, 55, 86, 70, 12, 4, 99, 16, 14]	
	...
	print "testing string_lower_count('Please Let Me Go HOME please, that would be nice'): ", string_lower_count('Please Let Me Go HOME please, that would be nice')
